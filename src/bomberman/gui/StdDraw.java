...
public final class StdDraw implements ActionListener, MouseListener,
	 ...
	 * Pantone 300U. The RGB values are approximately (9, 90, 266).
	 */
	public static final Color BOOK_BLUE = new Color(9, 90, 166);
	public static final Color BOOK_LIGHT_BLUE = new Color(103, 198, 243);

	/**
	 * Shade of red used in Algorithms 4th edition. It is Pantone 1805U. The
	 * approximate RGB values are (150, 35, 31).
	 */
	...
	public static void save(final String filename) {
		...
		// http://archives.java.sun.com/cgi-bin/wa?A2=ind0404&L=java2d-interest&D=0&P=2727
			...
			newRaster = raster.createWritableChild(0, 0, width, height, 0, 0,
					new int[] { 0, 1, 2 });
			DirectColorModel cm = (DirectColorModel) offscreenImage
					.getColorModel();
